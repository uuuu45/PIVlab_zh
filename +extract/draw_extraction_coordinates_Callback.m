...
if size(resultslist,2)>=currentframe && numel(resultslist{1,currentframe})>0
	...
	if (strcmp(caller.Tag,'draw_stuff') && strcmp(handles.draw_what.String{handles.draw_what.Value},'折线')) || (strcmp(caller.Tag,'draw_stuff_area') && strcmp(handles.draw_what_area.String{handles.draw_what_area.Value},'多边形'))%polyline
	...
	elseif (strcmp(caller.Tag,'draw_stuff') && strcmp(handles.draw_what.String{handles.draw_what.Value},'圆')) || (strcmp(caller.Tag,'draw_stuff_area') && strcmp(handles.draw_what_area.String{handles.draw_what_area.Value},'圆'))%circle
		if strcmp(caller.Tag,'draw_stuff') %extract from polyline
	...
	elseif (strcmp(caller.Tag,'draw_stuff') && strcmp(handles.draw_what.String{handles.draw_what.Value},'圆序列（仅切向速度）')) || (strcmp(caller.Tag,'draw_stuff_area') && strcmp(handles.draw_what_area.String{handles.draw_what_area.Value},'圆序列'))%circle series
		if strcmp(caller.Tag,'draw_stuff') %extract from polyline
	...
	elseif strcmp(caller.Tag,'draw_stuff_area') && strcmp(handles.draw_what_area.String{handles.draw_what_area.Value},'矩形') %rectangle
