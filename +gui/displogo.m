...
text (target_axis,1025,800,['版本：' gui.retr('PIVver')], 'fontsize', 10,'horizontalalignment','right');
...
if imgproctoolbox==0
    text (target_axis,90,200,'未找到图像处理工具箱！', 'fontsize', 16, 'color', [1 0 0], 'backgroundcolor', [0 0 0]);
end
